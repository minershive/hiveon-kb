...
Списание средств с баланса происходит за предыдущий день. Например: 0.5$ спишется с вашего баланса в 04:00 4 июня за 5 ригов онлайн с 04:00 3 июня по 04:00 4 июня.
...
- майнинга Ethereum или Ethereum Classic на пуле [Hiveon](https://www.hiveon.net)
- майнинга других монет, кроме Ethereum и Ethereum Classic, на любых других пулах


Если 2 и более ваших воркеров майнят Ethereum или Ethereum Classic не на пуле [Hiveon](https://www.hiveon.net), применяется стандартный тариф 3$/мес. за каждый такой воркер.
...
- с помощью платежного шлюза [Coinpayments](https://www.coinpayments.net/) (принимаются BTC, LTC, XMR). Узнать об осуществлении платежей подробнее можно [здесь](https://hiveos.farm/faq-billing_in_hive_os-payment_ru/).
...
Для платных пользователей, которые добывают криптовалюту Ethereum или Ethereum Classic, существует опциональная возможность оплачивать Hive OS за счет майнинга на пуле Hiveon и удерживаемой комиссии 3% от добычи в качестве оплаты за Hive OS.

Обратите внимание, что этот способ применим только к устройствам, осуществляющим добычу Ethereum или Ethereum Classic на пуле Hiveon. К остальным устройствам будет применен стандартный тариф.

Узнать об этой возможности больше можно [здесь](https://medium.com/hiveon/оплата-в-hive-os-важные-обновления-536d42d2c867).
...
Если же вы, например, решили полностью прекратить майнить, вы можете обратиться [вот сюда]( https://t.me/HiveOS_FleaMarket). Там можно найти людей, покупающих балансы.

>По условиям использования системы, возврат на личный кошелек депозитов, бонусов и зачисленных средств, которые были внесены во время акций и привели к получению бонусов, невозможен.
...
Подробнее про условия реферальной системы читайте [здесь](https://hiveos.farm/faq-billing_in_hive_os-referral_ru).

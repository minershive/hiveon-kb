...
В нашей [предыдущей статье](file://getting_started\start_worker_setup_ru.md) мы обсудили установку и настройку воркеров. Теперь же мы продолжим знакомить вас с Hive и покажем, как работать с её основными функциями. Начнем с ферм.

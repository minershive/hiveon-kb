...
Да, оплата за опоздавшие шары (т. н., Stale Shares) также производится, но с применением коэффициента 0.6-0.8, в зависимости от сетевых задержек.


> __*Дорогие майнеры*__

_С сегодняшнего дня мы меняем правила выплаты опоздавших шар. Для опоздавших шар **до 6%**, условия остаются такими же. Начиная **с 6% и выше**, пул замораживает выплаты, что означает, что вы не получите деньги за свои опоздавшие шары. Если проблема с высокими шарами сохраняется в течение 48 часов, кошелек заносится в черный список, а выплаты замораживаются до дальнейшего уведомления._
